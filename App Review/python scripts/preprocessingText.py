...
def getSentences(reviewFile):
    sentences = []
    with open(outputPath+reviewFile) as processedFile:
...
def makeModel(sentences):
    ...
    #
    # reviews2vec.save("../trained-models/facebook.w2v")

    return reviews2vec

def saveModel(model, modelName):
    modelName = modelName[:-4]
    if not os.path.exists("../trained-models2/"):
        os.mkdir("../trained-models2/")
    model.save("../trained-models2/" + modelName + ".w2v")
